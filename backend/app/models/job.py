...
class Job(Base):
    ...
    hiring_manager: Mapped[str | None] = mapped_column(String(200), nullable=True)
    ...
    smart_tags: Mapped[list] = mapped_column(JSON, default=list)
    ...
    archive_reason: Mapped[str | None] = mapped_column(String(50), nullable=True)  # low_match|missing_experience|missing_skills|expired
