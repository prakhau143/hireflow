...
async def _user_jobs(db: AsyncSession, user_id: str) -> list[SimpleNamespace]:
    ...
    return [
        SimpleNamespace(
            ...
            confidence_score=j.confidence_score, contact_email=j.contact_email,
            contact_phone=j.contact_phone, contact_linkedin=j.contact_linkedin,
            apply_link=j.apply_link, hiring_manager=j.hiring_manager,
            match_score=m.match_score, matched_skills=m.matched_skills,
            missing_skills=m.missing_skills, missing_skills_detail=m.missing_skills_detail,
            apply_probability=m.apply_probability, match_tier=m.match_tier,
